        ...
        <form action="updatedata.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <br><input type="checkbox" id="ubah_foto" name="ubah_foto" value="true"> Ceklis jika ingin mengubah
                    foto<br>
                ...
                <div class="form-group">
                    <br>
                    <label">Judul</label>
                        <input type="text" name="judul" class="form-control" value="<?php echo $editdata['judul'] ?>"
                            required>
                </div>
